...
public class TrafficConstant {
    ...
    // the traffic graph
    public static String TrafficGraph = "tl44,tl42,tl43,#,tl19;tl44,tl43,tl19,tl42,#;"
    ...
    // Constant now. the probability of one turning's turning rate{left, right, straight}.
    public static double[] TurnRate = new double[]{0.1, 0.1, 0.8};

    // Constant now. the count of one node's capacity {left, right, straight}.
    public static int[] ThroughRate = new int[]{2, 2, 16};
